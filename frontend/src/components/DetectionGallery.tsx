  ...
  if (frames.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-1">No detections available</h3>
        <p className="text-gray-600">The video processing didn't detect any trash in this footage. Try adjusting the confidence threshold or upload a different video.</p>
      </div>
    );
  }
